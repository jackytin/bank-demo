...
public class TextUtils {
  ...
  public static String hashStringWithSHA256(String valueToHash, String salt) {
    try {
      ...
      String textToHash = new StringBuilder(valueToHash).append(":").append(salt).toString();
  ...
  public static String repeat(
      String repeatedStr, int times, String seperator, boolean noSeperatorAtLast) {
    if (times <= 0) {
      return "";
    }
    StringBuilder sb = new StringBuilder();
