...
public class LoginData {
  ...
  protected static final String USER_APP = "user_app";
  ...
  public String getUserApp() {
    return (String) getData(USER_APP);
  }

  public void setUserApp(String userAppId) {
    setData(USER_APP, userAppId);
  }
}
